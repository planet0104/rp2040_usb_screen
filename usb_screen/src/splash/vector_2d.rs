...
use core::ops::{AddAssign, DivAssign, Mul, MulAssign, Sub, SubAssign};
...
impl Vector2D{
    ...
    pub fn dot(v1: &Vector2D, v2: &Vector2D)->f32{
        v1.x*v2.x + v1.y*v2.y
    }
    ...
    pub fn mul(v:&Vector2D, d: f32) ->Vector2D{
